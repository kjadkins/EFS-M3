...
//
// Description 
// Calculate and update Sales Price based on cost in MCHEAD together with order currency
//
...
public class UpdateCost_PEUPD extends ExtendM3Trigger {
  ...
  public UpdateCost_PEUPD(ProgramAPI program, DatabaseAPI database, InteractiveAPI interactive, LoggerAPI logger, MICallerAPI miCaller) {
