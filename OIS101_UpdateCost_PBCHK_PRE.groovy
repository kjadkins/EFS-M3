...
public class UpdateCost_PBCHK_PRE extends ExtendM3Trigger {
  ...
  public UpdateCost_PBCHK_PRE(ProgramAPI program, DatabaseAPI database, InteractiveAPI interactive, LoggerAPI logger, MICallerAPI miCaller) {
  ...
  public void main() {
    ...
    orderQtyString = interactive.display.fields.WBORQA
    ...
    if (costingSum7 != null && costingSum7 > 0d) {
        ...
        interactive.display.fields.OBPRMO = 8
        
        updPrice(orderNumber, String.valueOf(orderLineNumber), String.valueOf(orderLineSuffix), String.valueOf(newPrice))
  ...
  // Update Price
  //******************************************************************** 
  void updPrice(String orno, String ponr, String posx, String sapr) {
    def params = ["ORNO":orno, "PONR": ponr, "POSX": posx, "SAPR": sapr] 
    def callback = {
    Map<String, String> response ->
    }
    
    miCaller.call("OIS100MI","UpdPriceInfo", params, callback)
  ...
  void getRate(String cono, String divi, String cucd, String date) {
    def params = ["CONO":cono, "FDDI": divi, "TODI": divi, "FCUR": cucd, "TCUR": cucd, "CRTP": "1".toString(), "CUTD": date] 
    def callback = {
    Map<String, String> response ->
